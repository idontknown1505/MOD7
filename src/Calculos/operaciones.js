...
export default function operaciones(estado, nombreDeBoton) {
    ...
    if (nombreDeBoton === "COS") {
      ...
      if (estado.siguiente) {
        return {
          siguiente: Math.cos(Big(estado.siguiente))
            .toString(),
        }
      }
    ...
    if (nombreDeBoton === "SIN") {
      ...
      if (estado.siguiente) {
        return {
          siguiente: Math.sin(Big(estado.siguiente))
            .toString(),
        }
      }
    ...
    if (nombreDeBoton === "TAN") {
      ...
      if (estado.siguiente) {
        return {
          siguiente: Math.tan(Big(estado.siguiente))
            .toString(),
        }
      }
